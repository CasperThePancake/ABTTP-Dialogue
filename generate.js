...
function generateChoice() {
    output = ""
    //3 possible states
    output += "execute if score letterIndex dialogue matches 10.. if score choice dialogue matches 1 run data merge entity @e[type=text_display,tag=dialogue_td,limit=1] {text:'[{\"text\":\"\\\\n\"},{\"text\":\""+inputText[0].split("'").join("\\'").split('"').join('\\"')+"\\\\n\",\"color\":\"gold\"},{\"text\":\""+inputText[1].split("'").join("\\'").split('"').join('\\"')+"\\\\n\"},{\"text\":\""+inputText[2].split("'").join("\\'").split('"').join('\\"')+"\"}]'}"
    output += "\n"
    output += "execute if score letterIndex dialogue matches 10.. if score choice dialogue matches 2 run data merge entity @e[type=text_display,tag=dialogue_td,limit=1] {text:'[{\"text\":\"\\\\n\"},{\"text\":\""+inputText[0].split("'").join("\\'").split('"').join('\\"')+"\\\\n\"},{\"text\":\""+inputText[1].split("'").join("\\'").split('"').join('\\"')+"\\\\n\",\"color\":\"gold\"},{\"text\":\""+inputText[2].split("'").join("\\'").split('"').join('\\"')+"\"}]'}"
    output += "\n"
    if (document.getElementById("options").value == 3) {
        output += "execute if score letterIndex dialogue matches 10.. if score choice dialogue matches 3 run data merge entity @e[type=text_display,tag=dialogue_td,limit=1] {text:'[{\"text\":\"\\\\n\"},{\"text\":\""+inputText[0].split("'").join("\\'").split('"').join('\\"')+"\\\\n\"},{\"text\":\""+inputText[1].split("'").join("\\'").split('"').join('\\"')+"\\\\n\"},{\"text\":\""+inputText[2].split("'").join("\\'").split('"').join('\\"')+"\",\"color\":\"gold\"}]'}"
        output += "\n"
